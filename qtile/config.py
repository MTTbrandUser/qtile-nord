...
colors = [["#2E3440", "2E3440"], # panel background
          ...
          ["#A3BE8C", "#A3BE8C"], # border line color for current tab
          ...
          ["#EBCB8B", "#EBCB8B"]] # backbround for inactive screens
...
def init_widgets_list():
    widgets_list = [
                widget.TextBox(
                    ...
                    padding=0,
                    background=colors[5],
                    mouse_callbacks={'Button1': lambda: qtile.cmd_spawn("rofi -show drun -show-icons -display-drun \"Run: \" -drun-display-format \"{name}\"")},
                    foreground=colors[2],
                ),
              widget.TextBox(
                       text = '',
...
def init_screens():
    return [Screen(top=bar.Bar(widgets=init_widgets_screen1(), opacity=0.9, margin=[5,20,1,20], size=23)),
            Screen(top=bar.Bar(widgets=init_widgets_screen2(), opacity=0.9, margin=[5,20,1,20], size=23)),
            Screen(top=bar.Bar(widgets=init_widgets_screen1(), opacity=0.9, margin=[5,20,1,20], size=23))]
